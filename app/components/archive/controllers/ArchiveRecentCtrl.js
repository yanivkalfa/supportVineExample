...
/**
 * Archive Recent Controller
 */
(function(ng) {
  ng.module('supportVine')
    .controller('ArchiveRecentCtrl', [
      '$scope', '$stateParams', '$state', 'MessageServices', 'UserService','SvSelectChannelFilterService', 'CaseTabsService',
      function($scope, $stateParams, $state, MessageServices,  UserService, SvSelectChannelFilterService, CaseTabsService) {
